 ...
 */
class ProcessAnalyze41 extends Process {
  constructor() {
    super();
    // Dependencies.
    this.env = new Env();
  ...
  process() {
    const chart = (data) => `
      ...
      <body>
        <h1>Microservices Age in Comparison with Database Technologies</h1>
        ...
        const scatterPlot = {
          ...
          hovertemplate: 'age: %{x}yo, # databases technologies: %{y}',
        };
    ...
    const analyze = async () => {
      ...
      let html = path.join('results', 'analyze-41.html');
...
let process41 = new ProcessAnalyze41();
process41.process();
