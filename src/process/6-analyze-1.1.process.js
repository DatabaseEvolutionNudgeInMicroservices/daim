 ...
 */
class ProcessAnalyze11 extends Process {
  constructor() {
    super();
    // Dependencies.
    this.env = new Env();
  ...
  process() {
    ...
    const analyze = async () => {
      // ---
      // ANALYZE: microservices per database / X = database technologies sorted in descending order by microservice occurences ; Y = microservice occurences.
      // ---
      ...
      let html = path.join('results', 'analyze-11.html');
...
let processAnalyze11 = new ProcessAnalyze11();
processAnalyze11.process();
